...
<html lang="en">
	...
	<body class="login" style="background-image: linear-gradient(to bottom right, pink,tomato,grey);">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div style="margin-left: 425px;">
					<a href="http://localhost/index.php"><input type="submit" name="" value="Home" style="background-color: Red; color: white; font-size: 18px;height: 35px"></a>
